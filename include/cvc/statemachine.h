...
#define MIN_PRECHARGE_VOLTAGE 80.0  // Minimum voltage for AIR2 closing (2.7V per cell * 60 cells)
#define MIN_PRECHARGE_PERCENT 0.90   // Threshold for bus voltage to be considered precharged relative to battery voltage (90% of battery voltage)
